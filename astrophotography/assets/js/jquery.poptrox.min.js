! function(e) {
    e.fn.poptrox_disableSelection = function() {
        ...
        var p, i, s = e.extend({
            ...
            f = function() {
                ...
                var e = Math.abs(x.width() - x.outerWidth()),
                    ...
                    t = p - 0.5* s.windowMargin - e,
                    r = i - 0.5* s.windowMargin - o;
        ...
        return l.on("resize orientationchange", function() {
            ...
            return !!h || (h = !0, s.useBodyOverflow && n.css("overflow", "hidden"), s.onPopupOpen && s.onPopupOpen(), x.addClass("loading"), void a.fadeTo(1, 1, function() {
